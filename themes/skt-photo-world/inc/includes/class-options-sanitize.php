...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-photoworld' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-photoworld' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-photoworld' ),
		'repeat'    => __( 'Repeat All', 'skt-photoworld' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-photoworld' ),
		'top center'    => __( 'Top Center', 'skt-photoworld' ),
		'top right'     => __( 'Top Right', 'skt-photoworld' ),
		'center left'   => __( 'Middle Left', 'skt-photoworld' ),
		'center center' => __( 'Middle Center', 'skt-photoworld' ),
		'center right'  => __( 'Middle Right', 'skt-photoworld' ),
		'bottom left'   => __( 'Bottom Left', 'skt-photoworld' ),
		'bottom center' => __( 'Bottom Center', 'skt-photoworld' ),
		'bottom right'  => __( 'Bottom Right', 'skt-photoworld')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-photoworld' ),
		'fixed'  => __( 'Fixed in Place', 'skt-photoworld')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-photoworld' ),
		'italic'      => __( 'Italic', 'skt-photoworld' ),
		'bold'        => __( 'Bold', 'skt-photoworld' ),
		'bold italic' => __( 'Bold Italic', 'skt-photoworld' )
		);
