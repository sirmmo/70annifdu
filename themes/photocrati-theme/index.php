<?php
    ...
    $is_sidebar_enabled = $preset->is_sidebar_enabled;
...
<div id="container">
    ...
    <?php
  	if ($preset->is_sidebar_enabled() && $preset->sidebar_alignment_responsive == 'top') {
  		get_sidebar(); 
  	}
    ?>    
        ...
        <?php while ( have_posts() ) : the_post() ?>
            ...
            <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <div class="entry-meta">
                    ...
                    <span class="comments-link"><?php comments_popup_link( __( '0 Comments', 'photocrati-framework' ), __( '1 Comment', 'photocrati-framework' ), __( '% Comments', 'photocrati-framework' ) ) ?></span>
    ...
    <?php 
  	if ($preset->is_sidebar_enabled() && $preset->sidebar_alignment_responsive == 'bottom') {
  		get_sidebar(); 
  	}
    ?>    
