...
<?php $page_comments = Photocrati_Style_Manager::get_active_preset()->page_comments ?>
      ...
      <?php 
    	...
    	if (Photocrati_Style_Manager::get_active_preset()->sidebar_alignment_responsive == 'top') {
    		get_sidebar(); 
    	}
      ?>   
      ...
      <?php 
    	if (Photocrati_Style_Manager::get_active_preset()->sidebar_alignment_responsive == 'bottom') {
    		get_sidebar(); 
    	}
      ?>    
